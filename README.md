...
## Limite arquitetural da v0.5.0

O carrinho é local e serve à experiência de montagem do pedido. A v0.5.0 enviará os itens ao servidor, que deverá consultar novamente os produtos e recalcular todos os valores antes de criar o pedido. O back-end nunca deverá confiar em preços recebidos do navegador.

## Próxima versão

A versão 0.5.0 adicionará identificação do cliente, endereço, entrega ou retirada, criação do pedido e painel operacional de pedidos.
