...
async function main(): Promise<void> {
  ...
  const store = await prisma.store.upsert({ where: { slug: 'demo' }, update: {}, create: { companyId: company.id, name: 'MenuCommerce Demo', slug: 'demo', description: 'Hambúrgueres artesanais e acompanhamentos.', whatsapp: '5512999999999',
      whatsappEnabled: true, bannerUrl: 'https://images.unsplash.com/photo-1515003197210-e0cd71810b5f?auto=format&fit=crop&w=1600&q=80' } });
